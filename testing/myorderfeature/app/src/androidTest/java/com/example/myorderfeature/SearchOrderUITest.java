// Scenario 2: Espresso test for searching past orders
...
public class SearchOrderUITest {
    ...
    // display the matched item with the order number
    @Test
    ...
    // show error message when no order exists or invalid order number
    @Test
